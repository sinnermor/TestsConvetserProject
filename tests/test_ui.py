...
Обратите внимание, при покупке или продаже валюты с использованием карты,
списание средств со счета карты проводится по курсу, действующему на
